            ...
            with open(secrets_path) as f:
                for line in f:
                    if line.startswith("DB_PASSWORD="):
                        ...
                        break
    if not db_password:
        # Crawdad directive: no hardcoded passwords. Fail loud.
        raise RuntimeError("No DB password found. Set CHEROKEE_DB_PASS env var or check /ganuda/config/secrets.env")
