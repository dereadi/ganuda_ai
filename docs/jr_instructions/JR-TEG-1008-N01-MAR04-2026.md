# [TEG] Fix council guidance map and add DC-6 gradient anchors - Node n01

**Parent Task**: #1008
**Auto-decomposed by TEG Planner**: 2026-03-04T11:00:42.445873
**Operation**: create
**Target File**: `/ganuda/config/council_guidance/crawdad.md`
