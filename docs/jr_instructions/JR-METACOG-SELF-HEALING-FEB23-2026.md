# Jr Instruction: Metacognitive Self-Healing Pipeline

**Task ID:** METACOG-HEAL
**Kanban:** #1801
**Priority:** 3
...
Wire metacognitive observer into self-healing pipeline. Monitors council vote quality over rolling window and alerts on drift.

---

## Step 1: Create the metacognitive self-healing module

Create `/ganuda/lib/metacog_self_healing.py`
...
```text
python3 -c "from metacog_self_healing import check_council_health; import json; print(json.dumps(check_council_health(), indent=2))"
```
