# Jr Task: Generate Test Images

Create synthetic test images for VLM testing.

**File:** `/ganuda/scripts/generate_test_frames.py`
...
def create_image(name, label, color):
...
Run: `python3 /ganuda/scripts/generate_test_frames.py`
