# JR INSTRUCTIONS: Cascaded Council Implementation (Executable)
## December 17, 2025

### OBJECTIVE
Add cascaded voting mode to the LLM Gateway's council system.

---

## TASK 1: Create Cascaded Vote Module

Create `/ganuda/lib/cascaded_council.py`:
...
## TASK 2: Create SQL Schema Updates

Create `/ganuda/sql/cascaded_votes_schema.sql`:
...
```bash
cd /ganuda/lib && /home/dereadi/cherokee_venv/bin/python3 cascaded_council.py
```
...
1. cascaded_council.py runs self-test successfully
2. SQL schema updates apply without errors
3. Cascaded votes return stage information
4. Blocking works at stages 1-2
