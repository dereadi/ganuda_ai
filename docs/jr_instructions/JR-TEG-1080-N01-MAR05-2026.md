# [TEG] Service Registry Port Map CMDB Table - Node n01

**Parent Task**: #1080
**Auto-decomposed by TEG Planner**: 2026-03-05T22:18:55.899963
**Operation**: create
**Target File**: `/ganuda/scripts/migrations/seed_service_registry.py`
