...
**Task ID:** JR-CURIOSITY-ENGINE
**Priority:** P2
**Story Points:** 5
**Council Owner:** Deer (Peace Chief)
**DC References:** DC-9, DC-10, DC-11

Deploy the Curiosity Engine -- Peace Chief stub-filling pipeline. Extracts stubs (named entities, concepts) from partner-shared content, routes them, buffers through the Flux Capacitor, and queues research at a sustainable rate.

### Step 1: Create the Curiosity Stubs Table
...
```bash
cd /ganuda && python3 /ganuda/lib/curiosity_engine.py --setup
```
