# Jr Instruction: Council Web Research Tool

**Task ID:** COUNCIL-WEBRESEARCH
**Kanban:** #1836
**Priority:** 3
...
Create a web search module for council specialists. Uses DuckDuckGo (no API key) for search and BeautifulSoup for page extraction.

---

## Step 1: Create the web research module

Create `/ganuda/lib/council_web_research.py`
...
```text
python3 -c "from council_web_research import search_web; print(search_web('Cherokee Nation'))"
```
