# Jr Task: VLM Relationship Storer

Store extracted entities and relationships in thermal_relationships table.

**Assigned to:** Software Engineer Jr.
**Node:** bluefin (192.168.132.222)
**Priority:** High
**Depends on:** VLM Entity Extractor

## Objective

Create `/ganuda/lib/vlm_relationship_storer.py` that:
1. Takes VLMExtraction from entity extractor
2. Creates thermal memories for entities
3. Creates thermal_relationships between them
4. Returns IDs for clause evaluation
...
```bash
cd /ganuda/lib
python3 vlm_relationship_storer.py
```
...
2. Creates thermal memories for entities
3. Creates thermal_relationships with correct provenance='vlm'
