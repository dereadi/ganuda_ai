# [TEG] Duplo Context Profiles (Enzyme Active Sites) - Node n00

**Parent Task**: #965
**Auto-decomposed by TEG Planner**: 2026-03-01T10:00:39.374937
**Operation**: create
**Target File**: `/ganuda/lib/duplo/context_profiles/crawdad_scan.yaml`

---

Create `/ganuda/lib/duplo/context_profiles/crawdad_scan.yaml`
