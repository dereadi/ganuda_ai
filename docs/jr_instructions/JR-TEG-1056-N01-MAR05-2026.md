# [TEG] Entity Resolution Phase 1: Bridge table + temporal state + backfill - Node n01

**Parent Task**: #1056
**Auto-decomposed by TEG Planner**: 2026-03-05T09:42:29.270662
**Operation**: create
**Target File**: `/ganuda/scripts/backfill_entity_links.py`

---

Create `/ganuda/scripts/backfill_entity_links.py`
