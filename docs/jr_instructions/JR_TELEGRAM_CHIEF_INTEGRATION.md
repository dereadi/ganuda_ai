# Jr Instructions: Telegram Chief Integration

**Priority**: 1 (Critical)
**Assigned Jr**: it_triad_jr
**Target**: Integrate module files into telegram_chief.py

---

### Task 1: Create Integrated Telegram Chief

Create `/ganuda/telegram_bot/telegram_chief_v3.py`:
...
2. /health shows cluster status
3. /memory shows thermal memories
4. /seed writes to thermal memory
5. /ticket creates Jr queue entries
6. /jrs shows work queue
