# Jr Instruction: SAG v2 Domain Prompts + Tool Definitions

**Task ID**: SAG-V2-PROMPTS
**Priority**: 2
...
## Objective
Create the system prompt and tool definitions for SAG v2. The system prompt guides the LLM to be a resource allocation assistant. The tool definitions map to the MCP server tools in OpenAI function-calling format.

## Step 1: Create prompts.py

Create `/ganuda/services/sag-v2/prompts.py`
