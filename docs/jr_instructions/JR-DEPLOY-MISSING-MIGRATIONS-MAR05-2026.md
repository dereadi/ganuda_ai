# JR Instruction: Deploy Missing Database Migrations

**Task**: Run council_feedback_loop and longhouse schema migrations on bluefin
**Priority**: 6 (MEDIUM — data infrastructure)
**Sacred Fire**: No
...
Tech debt audit found 2 migration scripts that were created but never deployed to bluefin PostgreSQL. These tables support Council prediction feedback loops and Outer Council (Longhouse) data storage.

## Changes

### Step 1: Create migration runner script

Create `scripts/migrations/deploy_missing_mar05.py`
