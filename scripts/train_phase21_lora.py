#!/usr/bin/env python3
"""
PHASE 2.1: CHEROKEE RESONANCE LORA TRAINING - REGRESSION FIX
...
- Phase 2.1 Addition: 602 direct answer scenarios
...
CORPUS_PATH = "/ganuda/phase21_merged_training_corpus.txt"
OUTPUT_DIR = "/ganuda/cherokee_resonance_training/phase21_lora"
...
logger.info("""
========================================================================
🦅 PHASE 2.1: LORA TRAINING - REGRESSION FIX
========================================================================
...
Corpus Summary:
  - Phase 2 Redux: 424 behavioral scenarios
  - Phase 2.1: 602 direct answer scenarios (3 types)
...
logger.info(f"📖 Loading Phase 2.1 merged corpus from {CORPUS_PATH}")
...
logger.info("""
========================================================================
🔥 STARTING PHASE 2.1 LORA TRAINING
========================================================================
...
logger.info(f"💾 Saving Phase 2.1 LoRA adapters to {OUTPUT_DIR}")
model.save_pretrained(OUTPUT_DIR)
tokenizer.save_pretrained(OUTPUT_DIR)

logger.info("""
========================================================================
✅ PHASE 2.1 LORA TRAINING COMPLETE
========================================================================
